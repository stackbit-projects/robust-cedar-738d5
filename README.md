...
1. Get "stackbit-deploy (Read+Write)" API token from your [Sanity management console](https://manage.sanity.io/projects/vxg4epm0/settings/api)
...
1. Run the following command to fetch the content from Sanity:
        ...
        npx @stackbit/sanity-pull --ssg gatsby --sanity-project-id vxg4epm0 --sanity-token $SANITY_ACCESS_TOKEN
...
To start editing your site, you can use the Sanity interface at https://robust-cedar-738d5.sanity.studio/.
...
Generated at `2021-07-09T17:20:34.668Z` by Stackbit version `0.3.53`.